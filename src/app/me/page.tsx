      ...
      <div className={styles.mediaGrid}>
        {filteredMedia.length === 0 ? (
          ...
          filteredMedia.map((item) => (
            <div key={`${item.type}_${item.id}`} className={styles.mediaCard}>
              {/* Постер */}
              ...
              <div className={styles.mediaInfo}>
                <h3 className={styles.mediaTitle}>
                  <Link
                    href={getMediaLink(item.id, item.type)}
                    className={styles.mediaTitleLink}
                  >
                ...
                <div className={styles.userActions}>
                  <div className={styles.actionIcons}>
                    {item.isFavorite && (
                      <span className={styles.actionIcon} title="В избранном">
                        <Image
                          src="/icons/heart.svg"
                          alt="Favorite"
                          width={16}
                    ...
                    {item.isWatched && (
                      <span className={styles.actionIcon} title="Просмотрено">
                        <Image
                          src="/icons/eye.svg"
                          alt="Watched"
                          width={16}
                    ...
                    {item.userNote && (
                      <span className={styles.actionIcon} title="Есть заметка">
                        <Image
                          src="/icons/note.svg"
                          alt="Note"
                          width={16}
